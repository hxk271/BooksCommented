...
- 별로 기대하지 않았지만 생각보다 괜찮았던 masculinity 입문서. Raewyn Connell 아이디어의 입문서답지 않게 (은유와 환유를 포기하고) 실증적 방식으로 주장을 전개한 점에서 이론(Theory)을 좋아하는 이들에게는 별로 달갑지 않은 책일지도 모르겠음. 그래도 젠더와 사회 토픽에 관해 침대 위에 드러누워서도 읽을 수 있을 뿐만 아니라, 연구자에게는 경험적 연구를 위한 영감도 제공함.
