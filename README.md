...
- 전설적인 자기계발서로 낮은 시간선호(time preference)를 가진 이가 그렇지 않은 이보다 높은 소득을 거둔다는 일견 맞는 이야기를 짧게 끝맺는다. 자식의 시간선호를 늘리는 부모의 계층, 성공을 가능케 하는 사회자본과 같은 교란요인(confounders)을 발견하는 연습을 하기 좋은 (사격 용지같은) 교보재로 훌륭하다! 그건 그렇고 은근슬쩍 이 책에서 묘사된 (조나단과 찰리 사이의) 온후한 위계서열과 (가자와 가젤 사이의) 사회진화론은 놀라울만큼 딱 맞물리는데, 역시 성공의 개인적 귀인, 권위주의, 적자생존, 그리고 극우는 함께 가는 법인가?
