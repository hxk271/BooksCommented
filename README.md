...
- R에서 TF-IDF, 감정분석, n-gram, word network, 토픽 모형 등을 대통령 연설문, 네이버 댓글, 트윗 등 예제 자료로 연습할 수 있게 꾸며놓았다. 아마도 Silge and Robinson의 유명한 책 *Text Mining with R*에서 상당히 많은 영감을 얻은 것 같다. 한글 자연어처리의 기초 테크닉을 충분히 반복하고 있어 (너무 많은 기대를 하지 않는다면) 입문용으로 상당히 괜찮은데 강의 교재용으로는 약간 포지션이 미묘하다.
